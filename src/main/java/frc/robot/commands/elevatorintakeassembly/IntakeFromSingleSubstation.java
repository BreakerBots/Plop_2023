...
public class IntakeFromSingleSubstation extends ParallelCommandGroup {
  ...
  public IntakeFromSingleSubstation(Elevator elevator, Intake intake, boolean verifyIntakeAcutation, GamePieceType gamePieceType) {
    addCommands(
      new SetElevatorIntakeAssemblyState(elevator, intake, gamePieceType.isCube() ? ElevatorTargetState.PICKUP_SINGLE_SUBSTATION_CUBE : ElevatorTargetState.PICKUP_SINGLE_SUBSTATION_CONE, ActuatorMotorState.EXTENDING, verifyIntakeAcutation),
